    ...
    <div style={{position:"fixed",inset:0,background:"#00000088",zIndex:1000,display:"flex",alignItems:"center",justifyContent:"center",padding:"16px"}} onClick={onClose}>
      <div onClick={e=>e.stopPropagation()} style={{background:C.nox,borderRadius:16,width:"100%",maxWidth:640,boxShadow:"0 8px 48px #0008",border:`2px solid ${C.aurum}`,padding:"36px 40px",maxHeight:"85vh",overflowY:"auto",color:"#fff"}}>
        ...
        {[
          ...
          {tag:"Community",tit:"",righe:["In xNunc si trova qualcosa che ha costruito un collega. Lo ha affinato un altro. Lo ha migliorato qualcuno. Forse non ci si conosce nemmeno, ma facciamo tutti lo stesso lavoro e abbiamo le stesse necessità.","xNunc è questo: una collezione viva. Di strumenti, di pratiche, di conoscenza accumulata nel tempo. Nostra. Di chi c'è adesso, e di chi verrà dopo.","Si usa. Si migliora. Si crea. E ricomincia."]},
        ].map(({tag,righe})=>(
