    ...
    <div style={{position:"fixed",inset:0,background:"#00000088",zIndex:1000,display:"flex",alignItems:"center",justifyContent:"center",padding:"16px"}} onClick={onClose}>
      <div onClick={e=>e.stopPropagation()} style={{background:C.nox,borderRadius:16,width:"100%",maxWidth:640,boxShadow:"0 8px 48px #0008",border:`2px solid ${C.aurum}`,padding:"36px 40px",maxHeight:"85vh",overflowY:"auto",color:"#fff"}}>
        ...
        <div style={{marginBottom:28,paddingBottom:28,borderBottom:"1px solid #ffffff22",fontFamily:"Georgia,serif",fontSize:13.5,color:"#aaa",lineHeight:1.85}}>
          <span style={{fontStyle:"italic"}}>Ex nunc</span>{", è la locuzione latina che significa letteralmente \"da ora\" o \"da ora in poi\". Senza retroattività."}<br/><br/>{"È la nostra promessa: non stiamo ripensando il passato dello studio professionale. Stiamo cambiando cosa succede da adesso in poi."}
        </div>

        {[
          {tag:"Need",tit:"Ci vuole un motivo.",righe:["Tutto parte dai bisogni. Quando aiutiamo un cliente, la prima cosa che facciamo è capire la sua necessità reale — prima di proporre qualsiasi soluzione. xNunc nasce dalla stessa logica: dal bisogno di ogni professionista. Poter lavorare meglio non è un optional. È una necessità."]},
