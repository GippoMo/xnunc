        ...
        <div style={{maxWidth:1100,margin:"0 auto",padding:"0 16px",height:52,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:20}}>
            ...
            <div className="xnunc-nav-links">
              ...
              <a href="/novita" style={{color:"#888",fontSize:13,fontFamily:"Arial,sans-serif",textDecoration:"none"}} onMouseEnter={e=>e.target.style.color="#fff"} onMouseLeave={e=>e.target.style.color="#888"}>Novità</a>
            </div>
          </div>
