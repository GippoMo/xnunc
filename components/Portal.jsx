...
Genera i campi della skill in formato JSON. Rispondi SOLO con il JSON, senza markdown, senza commenti:
{
  ...
  function salvaNelleBoze(){
    ...
    const draft={
      ...
      creatore:`${userProfile?.nome||""} ${userProfile?.cognome||""}`.trim()||userProfile?.email||"Utente",
